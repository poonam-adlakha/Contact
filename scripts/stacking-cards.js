...
(function () {
  var StackCards = function (element) {
    ...
    this.itemsChildren = this.element.getElementsByClassName('js-stack-cards__item-child');
    ...
    for (var i = 0; i < this.items.length; i++) {
      ...
      if (scrolling > 0) {
        ...
        if (i !== this.items.length - 1) {
          this.itemsChildren[i].style.opacity = scaling / 1.05;
          this.itemsChildren[i].style.backgroundColor = 'rgba(0,0,0,' + (1 - scaling) + ')';
        }
      } else {
        this.items[i].style.transform = 'translateY(' + this.marginY * i + 'px)';
        this.itemsChildren[i].style.opacity = 1;
      }
    }
